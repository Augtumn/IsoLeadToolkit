...
| `Albarède & Juteau (1984)` | `single_stage` | T–μ–κ 参考模型（作者推荐版；2012 版作者表示不应使用）：x\*/y\*/z\*=18.750/15.63/38.83, μ\*=9.66, κ\*=3.90, T0=3.8 Ga, ²³⁸U/²³⁵U=137.79；反演见 [`docs/geochemistry.md`](geochemistry.md) §16 |
