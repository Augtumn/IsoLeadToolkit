"""HDBSCAN clustering for dimensionality-reduced data.

Provides unsupervised clustering of embedding results (UMAP, t-SNE,
PCA, RobustPCA) with soft cluster membership probabilities.
"""
