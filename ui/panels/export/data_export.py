...
class ExportPanelDataExportMixin:
    ...
    def _current_export_context() -> dict:
        ...
        return {
            ...
            'pca_component_indices': app_state.pca_component_indices,
    ...
    def _resolve_export_indices():
        ...
        sel = app_state.selected_indices
        if sel:
            return sorted(sel)
