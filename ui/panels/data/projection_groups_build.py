...
class DataPanelProjectionGroupsBuildMixin:
    """Per-algorithm projection parameter groups for the data panel."""

    def _build_umap_group(self, layout):
        """Build the UMAP parameter group."""
    ...
    def _build_tsne_group(self, layout):
        """Build the t-SNE parameter group."""
    ...
    def _build_pca_group(self, layout):
        """Build the PCA parameter group."""
    ...
    def _build_robust_pca_group(self, layout):
        """Build the RobustPCA parameter group."""
    ...
    def _build_ternary_group(self, layout):
        """Build the Ternary parameter group."""
