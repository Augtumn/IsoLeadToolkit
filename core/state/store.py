...
class StateStore:
    ...
    def __init__(self, state: Any) -> None:
        ...
        self._snapshot: dict[str, Any] = {
            ...
            "kde_clip_min": getattr(state, "kde_clip_min", None),
            "kde_clip_max": getattr(state, "kde_clip_max", None),
            "kde_common_norm": bool(getattr(state, "kde_common_norm", False)),
            "kde_warn_singular": bool(getattr(state, "kde_warn_singular", False)),
            "marginal_kde_clip_min": getattr(state, "marginal_kde_clip_min", None),
            "marginal_kde_clip_max": getattr(state, "marginal_kde_clip_max", None),
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        return {
            ...
            "kde_clip_min": self._snapshot["kde_clip_min"],
            "kde_clip_max": self._snapshot["kde_clip_max"],
            "kde_common_norm": bool(self._snapshot["kde_common_norm"]),
            "kde_warn_singular": bool(self._snapshot["kde_warn_singular"]),
            "marginal_kde_clip_min": self._snapshot["marginal_kde_clip_min"],
            "marginal_kde_clip_max": self._snapshot["marginal_kde_clip_max"],
