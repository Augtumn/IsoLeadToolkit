...
class LegendState:
    ...
    def __init__(self):
        ...
        self.legend_position = None  # 'upper left', etc. or None to hide
        self.legend_columns = 0  # 0 means auto
        self.legend_offset = (0.0, 0.0)  # Nudge in axes fraction
        ...
        self.hidden_groups: set = set()
        self.legend_to_scatter: dict = {}
