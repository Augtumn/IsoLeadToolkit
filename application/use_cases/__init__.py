...
__all__ = [
	...
	"export_to_origin",
	"export_to_origin_detailed",
	"export_origin_ready_data",
	"collect_origin_export_data",
	"fallback_export_rc",
...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
	...
	"collect_geochem_curve_data": ("export_data", "collect_geochem_curve_data"),
	...
	"export_to_origin_detailed": ("export_origin", "export_to_origin_detailed"),
	"export_origin_ready_data": ("export_origin", "export_origin_ready_data"),
	"collect_origin_export_data": ("export_origin", "collect_origin_export_data"),
	...
	"import_session": ("session_io", "import_session"),
	"export_session": ("session_io", "export_session"),
